...
Route::middleware(['admin:admin'])->group(function() {
    ...
    Route::get('admin/product/import', [ProductControllerForAdmin::class, 'showImportForm'])->name('admin.product.import.form');
    Route::post('admin/product/import', [ProductControllerForAdmin::class, 'import'])->name('admin.product.import');
